...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Turn Charity Commission data file into an SQLite DB"
    )
    ...
    ccew_out = os.path.join(args.data_dir, args.ccew_out)
    ...
    if args.ccew.startswith("http"):
        ...
        progress_bar.close()
        ccew_to_zip(tmp_zip_location, ccew_out, recreate=args.recreate)
    else:
        ccew_to_zip(args.ccew, ccew_out, recreate=args.recreate)
